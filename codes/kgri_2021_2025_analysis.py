...
RAW_FILE = PROJECT_DIR / "raw" / "KGRI_METAR_2021_2025_raw.csv"
INTERVAL_FILE = PROJECT_DIR / "results" / "KGRI_2021_2025_visibility_intervals.csv"
YEARLY_FILE = PROJECT_DIR / "results" / "KGRI_2021_2025_yearly.csv"
CHART_FILE = PROJECT_DIR / "pics" / "KGRI_2021_2025_lower_only_hours.png"
...
def main():
    ...
    for year in range(2021, 2026):
        ...
        current.loc[current["vsby"] < 0.75, "state"] = "lower_only"
        current.loc[current["vsby"] < 0.50, "state"] = "neither_option"
    ...
    ax.set_title("KGRI: Annual Hours When Only the Lower-Visibility Option Helps")
    ax.set_xlabel("Year")
    ax.set_ylabel("Hours")
    ...
    fig.text(
        0.5,
        0.01,
        "Weather-only screen: visibility from 0.50 to below 0.75 mile",
        ha="center",
        fontsize=9,
        color="#555555",
    )
