...
RAW_FILE = PROJECT_DIR / "raw" / "KAST_METAR_2021_2025_raw.csv"
INTERVAL_FILE = PROJECT_DIR / "results" / "KAST_2021_2025_visibility_intervals.csv"
YEARLY_FILE = PROJECT_DIR / "results" / "KAST_2021_2025_yearly.csv"
CHART_FILE = PROJECT_DIR / "pics" / "KAST_2021_2025_lower_only_hours.png"
...
def main():
    ...
    ax.set_title("KAST: Annual Hours When Only the Lower-Visibility Option Helps")
    ax.set_xlabel("Year")
    ax.set_ylabel("Hours")
