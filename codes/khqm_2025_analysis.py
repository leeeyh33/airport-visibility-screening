...
RAW_FILE = PROJECT_DIR / "raw" / "KHQM_METAR_2025_raw.csv"
INTERVAL_FILE = PROJECT_DIR / "results" / "KHQM_2025_visibility_intervals.csv"
SUMMARY_FILE = PROJECT_DIR / "results" / "KHQM_2025_visibility_summary.csv"
...
def main():
    ...
    weather.loc[weather["vsby"] < 1.25, "state"] = "lower_only"
