...
RAW_FILE = PROJECT_DIR / "raw" / "KHQM_METAR_2021_2025_raw.csv"
INTERVAL_FILE = PROJECT_DIR / "results" / "KHQM_2021_2025_visibility_intervals.csv"
YEARLY_FILE = PROJECT_DIR / "results" / "KHQM_2021_2025_yearly.csv"
CHART_FILE = PROJECT_DIR / "pics" / "KHQM_2021_2025_lower_only_hours.png"
...
def main():
    ...
    for year in range(2021, 2026):
        ...
        current.loc[current["vsby"] < 1.25, "state"] = "lower_only"
    ...
    ax.set_title("KHQM: Annual Hours When Only the Lower-Visibility Option Helps")
    ax.set_xlabel("Year")
    ax.set_ylabel("Hours")
    ...
    fig.text(
        0.5,
        0.01,
        "Weather-only screen: visibility from 0.50 to below 1.25 miles",
        ha="center",
        fontsize=9,
        color="#555555",
    )
