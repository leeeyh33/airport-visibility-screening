...
INTERVAL_FILE = PROJECT_DIR / "results" / "KAST_2021_2025_visibility_intervals.csv"
EVENT_FILE = PROJECT_DIR / "results" / "KAST_2021_2025_lower_only_events.csv"
SUMMARY_FILE = PROJECT_DIR / "results" / "KAST_2021_2025_event_summary.csv"
CHART_FILE = PROJECT_DIR / "pics" / "KAST_2021_2025_event_durations.png"
...
def main():
    ...
    bars = ax.bar(duration_counts.index, duration_counts.values, color="#F28E2B")
    ax.bar_label(bars, padding=3)
    ax.set_title("KAST Target-Weather Event Durations, 2021-2025")
