...
RAW_FILE = PROJECT_DIR / "raw" / "KGRI_METAR_2025_raw.csv"
INTERVAL_FILE = PROJECT_DIR / "results" / "KGRI_2025_visibility_intervals.csv"
SUMMARY_FILE = PROJECT_DIR / "results" / "KGRI_2025_visibility_summary.csv"
...
def main():
    ...
    weather.loc[weather["vsby"] < 0.75, "state"] = "lower_only"
    weather.loc[weather["vsby"] < 0.50, "state"] = "neither_option"
